...
<template>
 ...
 <el-table id="iTable" v-loading.iTable="options.loading" :data="list" :max-height="height" :stripe="options.stripe"
  ...
  <el-table-column :prop="column.prop"  :label="column.label" :align="column.align" :width="column.width" :key="column.pageIndex">
  ...
  <template slot-scope="scope">
   ...
   <template v-for="(btn, key) in operates.list">
    <div class="item" v-if="btn.show" :key="btn.show">
